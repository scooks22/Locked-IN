...
public class MoveRecord implements Serializable {
    ...
    public MoveRecord(int fromRow, int fromCol, int toRow, int toCol,
                      ...
                      boolean wasPromotion, boolean wasCastle) {
    ...
    public boolean wasPromotion()   { return wasPromotion; }
    public boolean wasCastle()      { return wasCastle; }
    ...
    public String toString() {
        ...
        if (wasCastle)    move = (toCol == 6) ? "O-O" : "O-O-O";
        if (capturedPiece != null) move += " x" + capturedPiece.getSymbol();
        if (wasPromotion) move += "=Q";
        return move;
    }
}
