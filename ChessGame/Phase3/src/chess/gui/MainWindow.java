...
public class MainWindow extends JFrame {
    ...
    private void onMoveMade(MoveRecord record) {
        ...
        if (status == GameState.Status.CHECKMATE) {
            String winner = gameState.getWinner() == PieceColor.WHITE ? "White" : "Black";
            JOptionPane.showMessageDialog(this,
                "Checkmate! " + winner + " wins!",
                "Game Over", JOptionPane.INFORMATION_MESSAGE);
        } else if (status == GameState.Status.STALEMATE) {
            JOptionPane.showMessageDialog(this,
                "Stalemate! The game is a draw.",
                "Game Over", JOptionPane.INFORMATION_MESSAGE);
        } else if (status == GameState.Status.CHECK) {
            String inCheck = gameState.getCurrentTurn() == PieceColor.WHITE ? "White" : "Black";
